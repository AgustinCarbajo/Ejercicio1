...
function ventaMaxima(vendedor: number[], semanas: string[]) {
 ...
 let texto = " vendio $" + mayor + " en la " + mesMayor;
  return texto;
}
...
let suma: number = 0;
  ...
  let prom = " tiene un promedio de " + suma / vendedor.length;
  return prom
}
...
//función que muestra su promedio mensual
...
//función para el mejor vendedor de la semana
  function mejorVendedorSem (nombre:string[],v1:number[],v2:number[],v3:number[],v4:number[],v5:number[]):string{
    let texto : string ="";
  ...
  console.log (mejorVendedorSem(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5));

  //Función mejor vendedor de cada mes
function mejorVendedorMen (nombre:string[],v1:number[],v2:number[],v3:number[],v4:number[],v5:number[],sem:number):string{
...
console.log ("El mejor de enero "+mejorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,1));
console.log ("El mejor de febrero "+mejorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,5));
console.log ("El mejor de marzo "+mejorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,9));

//Función peor vendedor de cada mes
function peorVendedorMen (nombre:string[],v1:number[],v2:number[],v3:number[],v4:number[],v5:number[],sem:number):string{
  let ven1:number=promedioMensual(vendedor1,sem);
  let ven2:number=promedioMensual(vendedor2,sem);
  let ven3:number=promedioMensual(vendedor3,sem);
  let ven4:number=promedioMensual(vendedor4,sem);
...
console.log ("El peor de enero "+peorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,1));
console.log ("El peor de febrero "+peorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,5));
console.log ("El peor de marzo "+peorVendedorMen(vendedoresNombres,vendedor1,vendedor2,vendedor3,vendedor4,vendedor5,9));

//Función para el peor vendedor del trimestre
function peorVendedorTri(
  nombre: string[],
  v1: number[],
  v2: number[],
  v3: number[],
